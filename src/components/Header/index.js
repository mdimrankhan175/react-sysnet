    ...
    <header className="header-container-small">
     ...
     <nav className="nav-container">
        <ul className="nav-list">
          ...
          <li><Link to="/contact_us" className="nav-link"><FaPhone style={{ fontSize: '1em', color: '#e67e22' }}  /></Link></li>
          <li><Link to="/follow_us" className="nav-link"><FaEnvelope style={{ fontSize: '1em',  color: '#3498db' }} /></Link></li>
        </ul>
      </nav>
    </header>
    </>
